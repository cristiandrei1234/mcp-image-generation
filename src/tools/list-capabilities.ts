...
export function registerListCapabilities(server: McpServer): void {
  server.registerTool(
    "list_capabilities",
    {
      ...
      description:
        "Returns the full reference for this MCP server: supported models (Flash 3.1 + Pro), auto-routing rules, aspect ratios, resolutions, reference-image budgets, retry behavior, and safety policies. Call this when unsure how to configure generate_image, edit_image, or the batch tools.",
      inputSchema: {},
    },
